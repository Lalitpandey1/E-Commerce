...
const Supplements = () => {
  ...
  return (
    <div className="w-full">
      <div className="hidden m1:flex w-full relative px-2 rounded-lg m3:px-6 flex-col gap-1 bg-[#ffff]">
        <div className="">
          {/* title */}
          <div className="flex ml-2 gap-2 items-center">
            <span className="text-green-300 text-xl font-semibold">|</span>
            <span className="font-semibold md:text-lg text-black text-sm">
              Supplements
            </span>
          </div>

          {/* Menu */}
          <div className="flex flex-nowrap mt-2 mb-1 text-black text-[13px] gap-2  ">
            <button>Oils</button>
      ...
      <div className="w-full m1:hidden bg-[#ffff] rounded-lg">
        ...
        <div className="">
          ...
          {/* Menu */}
          <div className="flex flex-nowrap my-1 ml-2 text-[13px] text-black gap-2 overflow-scroll scrollbar-hide">
            <button>Oils</button>
            <button>Skins&nbsp;&&nbsp;Hairs</button>
            <button>Vitality</button>
            <button className="whitespace-nowrap">Digestion</button>
